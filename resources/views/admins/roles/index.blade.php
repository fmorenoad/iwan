                    ...
                    <div class="col-md-12">
                        <div class="card data-tables">
                            <div class="card-header">
                                ...
                                <a href="{{route('roles.create')}}" class="btn btn-primary btn-fill pull-right"><i class="w3-xxlarge fa fa-plus"></i>{{ __('Role') }}</a>
                            </div>
                                    ...
                                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="{{ route('roles.edit', ['role' => $role]) }}" class="btn btn-sm btn-info">
                                                    <i class="w3-xxlarge fa fa-pencil"></i></a>
                                                </td>
                                                <td>
