                                ...
                                <div class="card-body ">
                                    <form action="{{route('admin.permissions.update', $permission)}}" method="post" class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-md-4 control-label">{{__('Permission')}}</label>
                                                <div class="col-md-8">
                                                    <input type="text" name="permission" id="permission" class="form-control" value="{{ old('permission', $permission->name) }}">
                                                </div>
                                            </div>
                                        </div>
                                </div>
