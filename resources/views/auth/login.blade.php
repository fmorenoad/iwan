@extends('layouts/app', ['activePage' => 'login', 'title' =>  env('APP_NAME')])

@section('content')
    <div class="full-page section-image" data-color="blue" data-image="{{ asset('img/full-screen-image-2.jpg') }}">
        <!--   you can change the color of the filter page using: data-color="black | blue | purple | green | orange | red | rose " -->
        <div class="content pt-5">
            <div class="container ">
                <div class="col-md-8 col-sm-9 ml-auto mr-auto mb-7">
                    <div class="text-center">
                        <h3 class="text-white">{{ __('Welcome to ') .  env('APP_NAME')}}</h1>
                        {{-- <p class="text-lead text-light mt-3 mb-0"> {{ __('Log in and see how you can save more than 150 hours of work with CRUDs for managing: #users, #roles, #items, #categories, #tags and more.') }}</p> --}}
                    </div>
                </div>
            </div>
